...
T = table2array(readtable('/home/helen/Documents/HelenExperimentalCode/perfectMoS2lattice.csv','HeaderLines',0));
...
T(:,1) = [];
T(1,:) = [];
input_multislice.spec_atoms= T;
input_multislice.spec_lx=105;
input_multislice.spec_ly=105;
input_multislice.spec_lz=10;
input_multislice.spec_dz=2;
